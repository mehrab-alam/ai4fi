  ...
  return (
    <motion.nav
      ...
      className={`fixed w-full z-50 transition-all duration-300 ${
        isScrolled ? "py-2 bg-background/80 backdrop-blur-xl border-b border-border shadow-sm" : "py-4 bg-transparent"
      }`}>
              ...
              <div className='flex gap-3'>
                ...
                <Link to='/signup'>
                  <motion.button
                    ...
                    whileTap={{ scale: 0.95 }}
                    onClick={() => {}}
                    className='bg-brand-color text-white px-6 py-2.5 rounded-xl font-medium  transition-all duration-300 flex items-center gap-2 text-sm'>
                    <span>SignUp</span>
                  </motion.button>
                </Link>
              </div>
              ...
              <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }}>
                {authService.isAuthenticated() ? (
                  ...
                  <Link to='/login'>
                    <button
                      onClick={() => {}}
                      className='w-full bg-gradient-to-r from-cyan-500 to-sky-600 text-white px-4 py-3 rounded-xl font-medium transition-all duration-300 flex items-center justify-center gap-2 text-sm'>
