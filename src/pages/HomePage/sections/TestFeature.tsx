...
// import {
//     Upload, Sparkles, ShoppingBag, Play,
//     ArrowRight, CheckCircle2
// } from 'lucide-react';

// /* --- SUB-COMPONENT: PROCESS STEP --- */
// const ProcessStep = ({ icon: Icon, title, desc, stepNum }) => (
...
//             {stepNum !== 3 && (
//                 <div className="absolute top-10 left-1/2 -translate-x-1/2 w-px h-12 bg-slate-100 group-hover:bg-blue-50 transition-colors delay-100"></div>
//             )}
//         </div>
...
//                 {title}
//             </h4>
//             <p className="text-sm text-slate-500 leading-relaxed mt-1 max-w-xs">
//                 {desc}
//             </p>
//         </div>
//     </div>
...
//                             <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-50 border border-blue-100 text-blue-600 text-[11px] font-bold uppercase tracking-widest">
//                                 <Sparkles size={12} />
...
// export default VirtualTrialHighlight;
...
// /* --- SUB-COMPONENT: FEATURE STEP --- */
// const StudioStep = ({ step, title, desc }) => (
//     <div className="flex gap-4 group">
//         <div className="flex flex-col items-center">
//             <div className="w-8 h-8 rounded-full bg-slate-100 border border-slate-200 flex items-center justify-center text-xs font-bold text-slate-500 group-hover:bg-slate-900 group-hover:text-white transition-colors duration-300">
//                 {step}
//             </div>
//             {/* Vertical Line */}
//             {step !== '3' && (
//                 <div className="w-px h-full bg-slate-100 my-2 group-hover:bg-slate-200 transition-colors"></div>
//             )}
//         </div>
...
//                             Studio Quality. <br />
//                             <span className="italic text-slate-400">Zero Equipment.</span>
//                         </h2>

//                         <p className="text-base text-slate-600 mb-10 leading-relaxed max-w-md">
//                             Turn boring product cutouts into high-converting lifestyle imagery. Our AI places your product in hyper-realistic environments instantly.
//                         </p>
...
//                                 desc="Upload a raw product photo or transparent cutout."
//                             />
//                             <StudioStep
//                                 step="2"
//                                 title="AI Scene Generation"
//                                 desc="Select a mood (e.g., 'Modern Kitchen', 'Outdoor Sunset')."
//                             />
//                             <StudioStep
//                                 step="3"
//                                 title="Export for Retail"
//                                 desc="Download 4K images optimized for Amazon & Shopify."
//                             />
//                         </div>

//                         {/* CTA */}
//                         <div className="mt-6">
//                             <button className="flex items-center gap-2 text-sm font-bold text-slate-900 hover:text-purple-600 transition-colors group">
//                                 Start Creating Scenes <ArrowRight size={16} className="group-hover:translate-x-1 transition-transform" />
//                             </button>
//                         </div>
//                     </div>


//                     {/* --- RIGHT: THE PRODUCT VISUALIZATION --- */}
//                     <div className="relative flex justify-center lg:justify-end">

//                         {/* Main Card Container */}
//                         <div className="relative w-full max-w-md bg-white rounded-2xl shadow-2xl shadow-slate-200 border border-slate-100 overflow-hidden group">

//                             {/* Card Header (SaaS UI) */}
//                             <div className="h-12 border-b border-slate-50 flex items-center justify-between px-4 bg-slate-50/50">
//                                 <div className="flex items-center gap-2">
//                                     <div className="w-2 h-2 rounded-full bg-slate-300"></div>
//                                     <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wide">Scene_Generator_Pro</span>
//                                 </div>
//                                 <div className="flex gap-2">
//                                     <div className="p-1.5 rounded-md bg-white border border-slate-100 text-slate-400 hover:text-slate-600 cursor-pointer">
//                                         <Download size={12} />
//                                     </div>
//                                 </div>
//                             </div>

//                             {/* The "Result" Image (Lifestyle) */}
//                             <div className="relative aspect-[4/3] bg-slate-100 overflow-hidden">
//                                 <img
//                                     src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=800&q=80"
//                                     alt="AI Generated Lifestyle Watch"
//                                     className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
//                                 />

//                                 {/* Floating "Input" Card (The Raw Product) */}
//                                 <div className="absolute top-6 left-6 w-20 h-20 bg-white rounded-lg p-1 shadow-lg border border-slate-100 transform -rotate-6 group-hover:rotate-0 transition-transform duration-500 z-20">
...
//                                         <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(#ccc 1px, transparent 1px)', backgroundSize: '4px 4px' }}></div>
//                                         <img
//                                             src="https://images.unsplash.com/photo-1523275335684-37898b6baf30?auto=format&fit=crop&w=200&q=80" // Using same image cropped for demo
//                                             className="w-12 h-12 object-contain mix-blend-multiply"
//                                             alt="Raw Input"
//                                         />
//                                     </div>
//                                     <div className="absolute -top-2 -right-2 bg-slate-900 text-white text-[8px] font-bold px-1.5 py-0.5 rounded shadow-sm">RAW</div>
//                                 </div>

//                                 {/* "AI Enhancement" Tooltip */}
//                                 <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/10 backdrop-blur-md border border-white/20 p-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100">
//                                     <Sparkles className="text-white drop-shadow-md" size={20} />
//                                 </div>

//                                 {/* Marketplace Ready Badge */}
//                                 <div className="absolute bottom-4 right-4 bg-white/90 backdrop-blur-sm px-3 py-2 rounded-lg border border-slate-100 shadow-lg flex items-center gap-3">
//                                     <div className="flex -space-x-2">
//                                         <div className="w-6 h-6 rounded-full bg-white border border-slate-100 flex items-center justify-center text-[8px] font-bold text-slate-700 shadow-sm z-20">Amz</div>
//                                         <div className="w-6 h-6 rounded-full bg-white border border-slate-100 flex items-center justify-center text-[8px] font-bold text-slate-700 shadow-sm z-10">eBay</div>
//                                     </div>
//                                     <div className="h-4 w-px bg-slate-200"></div>
//                                     <div className="flex items-center gap-1 text-[10px] font-bold text-slate-600">
//                                         <CheckCircle2 size={10} className="text-emerald-500" /> Ready
//                                     </div>
//                                 </div>
...
//                         <div className="absolute -bottom-8 -right-8 w-64 h-64 bg-slate-200/50 rounded-full blur-3xl -z-10 pointer-events-none"></div>
...
// export default LifestyleStudioSection;
...
//     return (
//         <section className="py-24 px-6 bg-slate-50 border-b border-slate-100 font-sans">
...
//                                 </div>
//                                 <div>
//                                     <h4 className="text-base font-bold text-slate-900">Upload Raw Product</h4>
...
//                                 </div>
//                                 <div>
//                                     <h4 className="text-base font-bold text-slate-900">AI Model Generation</h4>
//                                     <p className="text-sm text-slate-500 mt-1">Context-aware AI places your product on diverse, realistic models.</p>
//                                 </div>
//                             </div>
//                         </div>

//                         <button className="mt-10 px-8 py-4 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl shadow-lg shadow-slate-200/50 transition-all hover:-translate-y-1 flex items-center gap-2">
...
const AdStep = ({ icon: Icon, title, desc, stepNum, isLast }) => (
    <div className="flex gap-4 group">
        <div className="flex flex-col items-center">
            <div className="w-8 h-8 rounded-lg bg-white border border-slate-200 flex items-center justify-center text-xs font-bold text-slate-500 shadow-sm group-hover:border-purple-500 group-hover:text-purple-600 group-hover:bg-purple-50 transition-all duration-300 z-10 relative">
                {stepNum}
                {/* Glow effect on hover */}
                <div className="absolute inset-0 bg-purple-400 blur-md opacity-0 group-hover:opacity-20 transition-opacity"></div>
            </div>
            {!isLast && (
                <div className="w-px h-full bg-slate-100 my-2 group-hover:bg-purple-100 transition-colors"></div>
            )}
        </div>
        <div className="pb-8 pt-1">
            <h4 className="text-sm font-bold text-slate-900 mb-1 flex items-center gap-2">
                {title}
                <Icon size={14} className="text-slate-400 group-hover:text-purple-500 transition-colors" />
            </h4>
...
const AdGeneratorSection = () => {
    return (
        <section className="py-24 px-6 bg-white border-b border-slate-50 font-sans relative overflow-hidden">
            <style>{style}</style>
            ...
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
                    ...
                    <div className="relative flex justify-center lg:justify-end">
                        ...
                        {/* Main Interface Card */}
                        <div className="relative w-full max-w-md bg-white rounded-xl shadow-2xl shadow-slate-200/50 border border-slate-100 overflow-hidden transform transition-all duration-500 hover:shadow-purple-100/50 group cursor-default">
                            ...
                            <div className="h-10 border-b border-slate-100 flex items-center justify-between px-4 bg-slate-50/50">
                                <div className="flex items-center gap-2">
                                    <div className="w-2.5 h-2.5 rounded-full bg-slate-300"></div>
                                    <div className="w-2.5 h-2.5 rounded-full bg-slate-300"></div>
                                    <span className="text-[10px] font-bold text-slate-400 ml-2 uppercase tracking-wide">Ad_Studio_Pro</span>
                                </div>
                            ...
                            <div className="h-24 bg-white border-t border-slate-100 p-3 flex flex-col gap-2 relative overflow-hidden">
