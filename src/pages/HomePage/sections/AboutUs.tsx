...
import {
  Mail, MessageCircle, ChevronDown, Plus,
  Minus, HelpCircle, ArrowRight
} from 'lucide-react';
...
const FAQItem = ({ question, answer, isOpen, toggle }) => {
  return (
    <div className="border-b border-slate-200 last:border-0">
      ...
      >
        <span className={`text-lg font-medium transition-colors duration-300 ${isOpen ? 'text-blue-600' : 'text-slate-800 group-hover:text-blue-600'}`}>
          {question}
        </span>
        <div className={`relative flex items-center justify-center w-8 h-8 rounded-full transition-colors duration-300 ${isOpen ? 'bg-blue-100 text-blue-600' : 'bg-slate-100 text-slate-500 group-hover:bg-blue-50'}`}>
...
const SupportSection = () => {
  ...
  const faqs = [
    {
      question: "How does your AI model technology work?",
      answer: "Our advanced AI technology uses state-of-the-art Generative Adversarial Networks (GANs) and diffusion models. We combine computer vision to analyze your garment and neural networks to map it onto realistic, AI-generated human figures, ensuring accurate drape, texture, and fit without a physical photoshoot."
    },
    {
      question: "What types of clothing can be showcased?",
      answer: "We support a wide range of apparel including tops, bottoms, dresses, outerwear, and swimwear. Currently, complex multi-layered couture or highly transparent fabrics may require manual review, but our standard engine handles 95% of retail fashion categories instantly."
    },
    {
      question: "Do I own the rights to the generated images?",
      answer: "Yes, absolutely. Once you generate and download an image from our platform, you hold the full commercial license to use it for your e-commerce store, social media ads, and marketing campaigns worldwide."
    },
    {
      question: "Can I customize the model's ethnicity and body type?",
      answer: "Yes! Our platform prioritizes diversity. You can filter models by ethnicity, age range, and body type (including plus-size and petite) to perfectly match your brand's target audience."
    }
  ];
      ...
      <div className="max-w-4xl mx-auto space-y-20">
        ...
        <div className="text-center space-y-8">
          ...
          <div className="relative group mx-auto max-w-3xl">
            ...
            <div className="relative bg-white rounded-2xl p-8 md:p-10 shadow-xl flex flex-col md:flex-row items-center justify-between gap-8 border border-white/50">
              ...
              <div className="flex items-center gap-6 text-left">
                ...
                <div>
                  ...
                  <a href="mailto:support@ai4fi.com" className="text-sm font-semibold text-blue-600 mt-1 hover:underline">
                    support@ai4fi.com
                  </a>
                </div>
              </div>
              ...
              {/* Right: Action Button */}
              <button className="flex items-center gap-2 px-8 py-4 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg shadow-blue-200 transition-transform hover:-translate-y-1 w-full md:w-auto justify-center">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-slate-100">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 mt-2">Everything you need to know about our AI fashion platform</p>
          </div>
          ...
          <div className="mt-10 text-center">
            <a href="#" className="inline-flex items-center gap-1 text-sm font-bold text-slate-500 hover:text-blue-600 transition-colors">
