	...
	return (
		<div className="flex flex-col h-auto justify-center items-center bg-background  pb-16 lg:pt-28">
			<div className="max-w-7xl w-full flex flex-col md:flex-row justify-center items-center">
				...
				>
					<h6 className="text-foreground text-2xl font-semibold mb-6">
						Get in Touch
					</h6>
					<h2 className="text-lg text-brand-gradient sm:text-3xl md:text-4xl lg:text-5xl mb-6 leading-10">
					...
					<div className="flex items-center space-x-4">
						...
						<div>
							<a
								href="mailto:sales@apricityts.com"
				...
				<motion.div
					...
					animate={{ x: 0, opacity: 1, transition: { duration: 0.7 } }}
				>
					<h4 className="text-cyan-600 text-2xl font-semibold mb-6">
						Send us a message
					</h4>
					<form onSubmit={handleSubmit} className="space-y-4">
						...
						<div className="space-y-2">
							<label className="block text-cyan-600 font-medium">
								You are a
							</label>
						...
						<div className="space-y-2">
							<label className="block text-cyan-600 font-medium">
								Have you had a photoshoot before?
							</label>
							<div className="radio-buttons-container flex w-full gap-2 ">
								<div className="radio-button basis-1/2">
									<input
